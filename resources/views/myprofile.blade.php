                ...
                <div class="col-lg-8">
                    <div class="card section-card p-4 p-lg-5 mb-4">
                        ...
                        <p class="text-muted mb-0">
                            I build modern web applications with Laravel and Bootstrap, combining clean backend structure
                            with practical frontend design. My projects focus on usability, performance, and
                            maintainability.
                        </p>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="card section-card p-4 h-100">
                                ...
                                <p class="text-muted mb-0">Laravel, PHP, Bootstrap, JavaScript, MySQL, and responsive design
                                    workflows.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card section-card p-4 h-100">
                                ...
                                <p class="text-muted mb-0">Plan clearly, build iteratively, and keep communication simple
                                    during delivery.</p>
                            </div>
                        </div>
                    </div>
